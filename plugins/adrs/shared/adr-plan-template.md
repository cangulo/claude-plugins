...
Describe how the decision recorded in the summary will be implemented. Name the
components, files, or systems affected, and any sequencing or dependencies.
Honor the Requirements from the summary — call out how the plan satisfies them.

## 📋 Steps

1. First concrete step
2. Second concrete step
3. Verification — how you confirm the decision is satisfied (tests, checks)
